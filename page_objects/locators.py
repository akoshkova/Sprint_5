...
class RegistrationLocators:
 ...
 REGISTER_SUBMIT = (By.XPATH, "//button[contains(text(), 'Регистрация')]")  # Кнопка регистрации
...
class ConstructorLocators:
 # Конструктор
 BUNS_BUTTON = (By.XPATH, "//p[contains(text(), 'Булки')]")  # Кнопка булок
 SAUCES_BUTTON = (By.XPATH, "//p[contains(text(), 'Соусы')]")  # Кнопка соусов
 FILLINGS_BUTTON = (By.XPATH, "//p[contains(text(), 'Начинки')]")  # Кнопка начинок
